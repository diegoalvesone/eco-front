...
export function Empreendedores() {
  ...
  const onDelete = async () => {
    try {
      await axios.delete(
        `https://ecommerce-back-o6lv.onrender.com/empreendedores/${idEmpreendedor}`,
        {
          headers: {
  ...
  async function initializeTable() {
    try {
      const response = await axios.get(
        `https://ecommerce-back-o6lv.onrender.com/empreendedores?nome=${filtroNome}&page=${atualPage}&size=${10}`,
        {
          headers: {
