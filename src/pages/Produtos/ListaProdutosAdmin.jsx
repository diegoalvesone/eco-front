...
export function ListaProdutosAdmin() {
    ...
    const buscarProd = (id) => {
        return axios
            .get(`https://ecommerce-back-o6lv.onrender.com/produtos/${id}`)
            .then((response) => {
    ...
    useEffect(() => {
        axios.get(`https://ecommerce-back-o6lv.onrender.com/produtos?page=${atualPage}&size=${6}&nome=${pesquisa}`, {
            headers: {
    ...
    const onDelete = async () => {
        try {
            await axios.delete(
                `https://ecommerce-back-o6lv.onrender.com/produtos/${idProduto}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    async function initializeTable() {
        try {
            await axios
                .get(`https://ecommerce-back-o6lv.onrender.com/produtos`, {
                    headers: {
                                                ...
                                                <tr key={produto.id}>
                                                    ...
                                                    <Col className="image-container align-middle d-none d-sm-table-cell d-flex justify-content-center w-25" style={{ background: 'transparent' }}>
                                                        <Card.Img
                                                            ...
                                                            src={`https://ecommerce-back-o6lv.onrender.com/${produto.foto}`}
                                                        />
                                                    </Col>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Image
                                        ...
                                        src={`https://ecommerce-back-o6lv.onrender.com/${selecionaProd.foto}`}
                                        alt="Imagem"
                                    />
                                </Col>
                            </Row>
